...
<div class="modal fade" id="pickup_point" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <div class="pickup_alert_sms">  </div>
        ...
        <form class="pickup_form" action="{{ route('pickup_point.store') }}" method="post">
            @csrf
