...
@section('content')
	...
	<div class="home">
		...
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
            @isset($sub_category->subcategory_name)
                          ...
                          @foreach ($brands as $item)
                            <div class="owl-item">
                                <div class="brands_item d-flex flex-column justify-content-center">
                                    <a href="{{ route('brand_wise.product',$item->id) }}">
					...
					<div class="shop_sidebar">
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
                                @foreach ($child_category as $item)
								    <li><a href="{{ route('childCategory_wise.product',$item->id) }}">{{ $item->childcategory_name }}</a></li>
                                @endforeach
							</ul>
						</div>
						...
						<div class="sidebar_section">
							...
							<ul class="brands_list">
                                @foreach ($brands as $item)
								    <li class="brand"><a href="{{ route('brand_wise.product',$item->id) }}">{{ $item->brand_name }}</a></li>
                                @endforeach
							</ul>
						</div>
					</div>
